...
<body>
	<div class="app-well app-size bg-home">
		<div class="home-header">
			<h3 style="color: white; float: left">Schedule</h3>
		...
		<div class="content">
            <div class="set-schedule">
                ...
                <form action="./schedule_query.php" method="post">
                    <div class="form-group">
                        <label>mealtime</label>
                        <input type="text" class="form-control" name="mealtime" id="mealtime" />
                    </div>
                    <div class="form-group">
                        <label>playtime</label>
                        <input type="text" class="form-control" name="playtime" id="playtime"/>
                    </div>
                    <div class="form-group">
